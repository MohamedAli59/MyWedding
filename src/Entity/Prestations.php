...
class Prestations
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Mariages", mappedBy="prestation")
     */
    private $mariage;
    ...
    public function addMariage(Mariages $mariage): self
    {
    ...
    public function removeMariage(Mariages $mariage): self
    {
        if ($this->mariage->contains($mariage)) {
